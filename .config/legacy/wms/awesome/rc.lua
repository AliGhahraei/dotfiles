...
naughty.config.defaults.width = 1366
naughty.config.defaults.gap = 0
naughty.config.defaults.height = 32
naughty.config.defaults.timeout = 59
naughty.config.defaults.fg = '#ffffff'
naughty.config.defaults.bg = '#AF3DB3'
-- }}}
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "def", "ems", "web", "extra", "extra2", "extra3"}, s, layouts[1])
end
-- }}}
...
myawesomemenu = {
   ...
   { "edita config", editor_cmd .. " " .. awesome.conffile },
   { "púchale restarp", awesome.restart },
   { "sobras, varil", awesome.quit }
}
...
--[[ No queremos launcher, así que comentamos
